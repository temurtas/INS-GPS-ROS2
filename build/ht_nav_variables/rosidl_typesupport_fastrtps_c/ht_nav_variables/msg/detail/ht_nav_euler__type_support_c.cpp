...
#include "ht_nav_variables/msg/detail/ht_nav_euler__rosidl_typesupport_fastrtps_c.h"
...
using _HtNavEuler__ros_msg_type = ht_nav_variables__msg__HtNavEuler;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _HtNavEuler__ros_msg_type * ros_message = static_cast<const _HtNavEuler__ros_msg_type *>(untyped_ros_message);
  // Field name: roll
  {
  ...
  void * untyped_ros_message)
{
  ...
  _HtNavEuler__ros_msg_type * ros_message = static_cast<_HtNavEuler__ros_msg_type *>(untyped_ros_message);
  // Field name: roll
  {
    cdr >> ros_message->roll;
  }
...
static uint32_t _HtNavEuler__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ht_nav_variables__msg__HtNavEuler(
...
{
  return max_serialized_size_ht_nav_variables__msg__HtNavEuler(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_HtNavEuler = {
...
static rosidl_message_type_support_t _HtNavEuler__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_HtNavEuler,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ht_nav_variables, msg, HtNavEuler)() {
  return &_HtNavEuler__type_support;
}
