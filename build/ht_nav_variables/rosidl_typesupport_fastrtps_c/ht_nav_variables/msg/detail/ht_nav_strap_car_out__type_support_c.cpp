...
#include "ht_nav_variables/msg/detail/ht_nav_strap_car_out__rosidl_typesupport_fastrtps_c.h"
...
#include "ht_nav_variables/msg/detail/ht_nav_vector3__functions.h"  // car_pos, pos, vel
...
using _HtNavStrapCarOut__ros_msg_type = ht_nav_variables__msg__HtNavStrapCarOut;

static bool _HtNavStrapCarOut__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _HtNavStrapCarOut__ros_msg_type * ros_message = static_cast<const _HtNavStrapCarOut__ros_msg_type *>(untyped_ros_message);
  // Field name: time
  {
...
static bool _HtNavStrapCarOut__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _HtNavStrapCarOut__ros_msg_type * ros_message = static_cast<_HtNavStrapCarOut__ros_msg_type *>(untyped_ros_message);
  // Field name: time
  {
    cdr >> ros_message->time;
  }
...
size_t get_serialized_size_ht_nav_variables__msg__HtNavStrapCarOut(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _HtNavStrapCarOut__ros_msg_type * ros_message = static_cast<const _HtNavStrapCarOut__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_ht_nav_variables__msg__HtNavVector3(
    &(ros_message->car_pos), current_alignment);
  // field.name vel
...
static uint32_t _HtNavStrapCarOut__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ht_nav_variables__msg__HtNavStrapCarOut(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ht_nav_variables
size_t max_serialized_size_ht_nav_variables__msg__HtNavStrapCarOut(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
static size_t _HtNavStrapCarOut__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_ht_nav_variables__msg__HtNavStrapCarOut(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_HtNavStrapCarOut = {
  "ht_nav_variables::msg",
  "HtNavStrapCarOut",
  _HtNavStrapCarOut__cdr_serialize,
  _HtNavStrapCarOut__cdr_deserialize,
  _HtNavStrapCarOut__get_serialized_size,
  _HtNavStrapCarOut__max_serialized_size
};

static rosidl_message_type_support_t _HtNavStrapCarOut__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_HtNavStrapCarOut,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ht_nav_variables, msg, HtNavStrapCarOut)() {
  return &_HtNavStrapCarOut__type_support;
}
