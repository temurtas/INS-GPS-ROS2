...
bool ht_nav_variables__msg__ht_nav_deneme__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ht_nav_variables.msg._ht_nav_deneme.HtNavDeneme", full_classname_dest, 47) == 0);
  }
  ht_nav_variables__msg__HtNavDeneme * ros_message = _ros_message;
  {  // num
...
{
  /* NOTE(esteve): Call constructor of HtNavDeneme */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ht_nav_variables.msg._ht_nav_deneme");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "HtNavDeneme");
