...
#ifndef HT_NAV_VARIABLES__MSG__HT_NAV_WHEEL_VECTOR_H_
#define HT_NAV_VARIABLES__MSG__HT_NAV_WHEEL_VECTOR_H_
...
#endif  // HT_NAV_VARIABLES__MSG__HT_NAV_WHEEL_VECTOR_H_
