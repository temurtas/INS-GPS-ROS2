...
#include "ht_nav_variables/msg/detail/ht_nav_error_vector__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const ht_nav_variables::msg::HtNavErrorVector *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ht_nav_variables::msg::HtNavErrorVector *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _HtNavErrorVector__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const ht_nav_variables::msg::HtNavErrorVector *>(
...
{
  return max_serialized_size_HtNavErrorVector(full_bounded, 0);
}

static message_type_support_callbacks_t _HtNavErrorVector__callbacks = {
...
static rosidl_message_type_support_t _HtNavErrorVector__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_HtNavErrorVector__callbacks,
...
{
  return &ht_nav_variables::msg::typesupport_fastrtps_cpp::_HtNavErrorVector__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ht_nav_variables, msg, HtNavErrorVector)() {
  return &ht_nav_variables::msg::typesupport_fastrtps_cpp::_HtNavErrorVector__handle;
}
