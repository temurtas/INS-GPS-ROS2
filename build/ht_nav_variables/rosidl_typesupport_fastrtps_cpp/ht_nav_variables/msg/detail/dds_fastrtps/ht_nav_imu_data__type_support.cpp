...
#include "ht_nav_variables/msg/detail/ht_nav_imu_data__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ht_nav_variables::msg::HtNavImuData & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  ht_nav_variables::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.vel_diff,
    cdr);
  // Member: ang_diff
  ht_nav_variables::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.ang_diff,
    cdr);
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ht_nav_variables::msg::HtNavImuData & ros_message)
{
  // Member: time
  cdr >> ros_message.time;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ht_nav_variables
max_serialized_size_HtNavImuData(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  auto typed_message =
    static_cast<const ht_nav_variables::msg::HtNavImuData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ht_nav_variables::msg::HtNavImuData *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _HtNavImuData__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const ht_nav_variables::msg::HtNavImuData *>(
...
{
  return max_serialized_size_HtNavImuData(full_bounded, 0);
}

static message_type_support_callbacks_t _HtNavImuData__callbacks = {
...
static rosidl_message_type_support_t _HtNavImuData__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_HtNavImuData__callbacks,
...
{
  return &ht_nav_variables::msg::typesupport_fastrtps_cpp::_HtNavImuData__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ht_nav_variables, msg, HtNavImuData)() {
  return &ht_nav_variables::msg::typesupport_fastrtps_cpp::_HtNavImuData__handle;
}
