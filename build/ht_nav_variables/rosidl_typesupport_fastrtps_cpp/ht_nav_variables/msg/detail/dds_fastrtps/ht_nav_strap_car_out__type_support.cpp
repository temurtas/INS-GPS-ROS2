...
#include "ht_nav_variables/msg/detail/ht_nav_strap_car_out__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ht_nav_variables::msg::HtNavStrapCarOut & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ht_nav_variables::msg::HtNavStrapCarOut & ros_message)
{
  // Member: time
  cdr >> ros_message.time;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ht_nav_variables
max_serialized_size_HtNavStrapCarOut(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  auto typed_message =
    static_cast<const ht_nav_variables::msg::HtNavStrapCarOut *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ht_nav_variables::msg::HtNavStrapCarOut *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _HtNavStrapCarOut__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const ht_nav_variables::msg::HtNavStrapCarOut *>(
...
{
  return max_serialized_size_HtNavStrapCarOut(full_bounded, 0);
}

static message_type_support_callbacks_t _HtNavStrapCarOut__callbacks = {
...
static rosidl_message_type_support_t _HtNavStrapCarOut__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_HtNavStrapCarOut__callbacks,
...
{
  return &ht_nav_variables::msg::typesupport_fastrtps_cpp::_HtNavStrapCarOut__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ht_nav_variables, msg, HtNavStrapCarOut)() {
  return &ht_nav_variables::msg::typesupport_fastrtps_cpp::_HtNavStrapCarOut__handle;
}
