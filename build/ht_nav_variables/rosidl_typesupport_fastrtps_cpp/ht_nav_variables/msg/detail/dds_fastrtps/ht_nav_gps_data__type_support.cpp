...
#include "ht_nav_variables/msg/detail/ht_nav_gps_data__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ht_nav_variables::msg::HtNavGpsData & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ht_nav_variables::msg::HtNavGpsData & ros_message)
{
  // Member: gps_pos
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ht_nav_variables
max_serialized_size_HtNavGpsData(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  auto typed_message =
    static_cast<const ht_nav_variables::msg::HtNavGpsData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ht_nav_variables::msg::HtNavGpsData *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _HtNavGpsData__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const ht_nav_variables::msg::HtNavGpsData *>(
...
{
  return max_serialized_size_HtNavGpsData(full_bounded, 0);
}

static message_type_support_callbacks_t _HtNavGpsData__callbacks = {
...
static rosidl_message_type_support_t _HtNavGpsData__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_HtNavGpsData__callbacks,
...
{
  return &ht_nav_variables::msg::typesupport_fastrtps_cpp::_HtNavGpsData__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ht_nav_variables, msg, HtNavGpsData)() {
  return &ht_nav_variables::msg::typesupport_fastrtps_cpp::_HtNavGpsData__handle;
}
