...
#include "ht_nav_variables/msg/detail/ht_nav_kalman_out__rosidl_typesupport_fastrtps_cpp.hpp"
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ht_nav_variables
max_serialized_size_HtNavKalmanOut(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  auto typed_message =
    static_cast<const ht_nav_variables::msg::HtNavKalmanOut *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ht_nav_variables::msg::HtNavKalmanOut *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _HtNavKalmanOut__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const ht_nav_variables::msg::HtNavKalmanOut *>(
...
{
  return max_serialized_size_HtNavKalmanOut(full_bounded, 0);
}

static message_type_support_callbacks_t _HtNavKalmanOut__callbacks = {
...
static rosidl_message_type_support_t _HtNavKalmanOut__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_HtNavKalmanOut__callbacks,
...
{
  return &ht_nav_variables::msg::typesupport_fastrtps_cpp::_HtNavKalmanOut__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ht_nav_variables, msg, HtNavKalmanOut)() {
  return &ht_nav_variables::msg::typesupport_fastrtps_cpp::_HtNavKalmanOut__handle;
}
