...
static rosidl_typesupport_introspection_c__MessageMember HtNavImuData__rosidl_typesupport_introspection_c__HtNavImuData_message_member_array[3] = {
  {
    "time",  // name
    ...
    offsetof(ht_nav_variables__msg__HtNavImuData, time),  // bytes offset in struct
    NULL,  // default value
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ht_nav_variables, msg, HtNavImuData)() {
  ...
  HtNavImuData__rosidl_typesupport_introspection_c__HtNavImuData_message_member_array[2].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ht_nav_variables, msg, HtNavVector3)();
