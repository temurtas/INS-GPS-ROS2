...
class Metaclass_HtNavStrapCarOut(type):
    """Metaclass of message 'HtNavStrapCarOut'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'ht_nav_variables.msg.HtNavStrapCarOut')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__ht_nav_strap_car_out
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__ht_nav_strap_car_out
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__ht_nav_strap_car_out
            cls._TYPE_SUPPORT = module.type_support_msg__msg__ht_nav_strap_car_out
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__ht_nav_strap_car_out
...
class HtNavStrapCarOut(metaclass=Metaclass_HtNavStrapCarOut):
    """Message class 'HtNavStrapCarOut'."""
    ...
    _fields_and_field_types = {
        ...
        'car_pos': 'ht_nav_variables/HtNavVector3',
    ...
    def __init__(self, **kwargs):
        ...
        from ht_nav_variables.msg import HtNavVector3
        self.car_pos = kwargs.get('car_pos', HtNavVector3())
        from ht_nav_variables.msg import HtNavVector3
    ...
    def car_pos(self, value):
        if __debug__:
            ...
            assert \
                isinstance(value, HtNavVector3), \
                "The 'car_pos' field must be a sub message of type 'HtNavVector3'"
        self._car_pos = value
