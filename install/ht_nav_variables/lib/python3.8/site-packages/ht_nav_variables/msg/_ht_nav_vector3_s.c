...
bool ht_nav_variables__msg__ht_nav_vector3__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ht_nav_variables.msg._ht_nav_vector3.HtNavVector3", full_classname_dest, 49) == 0);
  }
  ht_nav_variables__msg__HtNavVector3 * ros_message = _ros_message;
  {  // x
...
{
  /* NOTE(esteve): Call constructor of HtNavVector3 */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ht_nav_variables.msg._ht_nav_vector3");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "HtNavVector3");
